...
class _PendapatanPageState extends ConsumerState<PendapatanPage> {
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      _buildFilterButton('Hari', 'hari', themeState),
                      _buildFilterButton('Minggu', 'minggu', themeState),
                      _buildFilterButton('Bulan', 'bulan', themeState),
                    ],
                  ),
                ),
              ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        height: 200,
                        child: _buildChart(themeState),
                      ),
                      const SizedBox(height: 16),
                      _buildChartLegend(themeState),
                    ],
                  ),
                ),
              ),
  ...
  Widget _buildFilterButton(String label, String value, ThemeState themeState) {
    ...
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: isSelected ? themeState.navbarColor : Colors.grey[200],
  ...
  Widget _buildChart(ThemeState themeState) {
          ...
          child: Column(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: _getChartColor(index, themeState),
  ...
  Widget _buildChartLegend(ThemeState themeState) {
    return Wrap(
      spacing: 12,
      runSpacing: 8,
      children: _chartData.asMap().entries.map((entry) {
  ...
  Color _getChartColor(int index, ThemeState themeState) {
    final colors = [
      themeState.navbarColor,
      Colors.green,
      Colors.orange,
...
class PendapatanChart extends ConsumerWidget {
  ...
  List<Map<String, dynamic>> _getChartData() {
    ...
    for (int i = 6; i >= 0; i--) {
      ...
      final dayPenjualan = this.data.where((p) {
        return p.tanggal.isAfter(dayStart) && p.tanggal.isBefore(dayEnd);
      }).toList();
